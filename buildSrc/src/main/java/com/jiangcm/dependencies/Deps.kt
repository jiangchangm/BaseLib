...
object Deps {
    ...
    const val kotlinxCoroutines = "org.jetbrains.kotlinx:kotlinx-coroutines-core:${DepsVersion.kotlinxCoroutinesVersion}"
    ...
    const val constraintlayout = "androidx.constraintlayout:constraintlayout:${DepsVersion.constraintlayoutVersion}"
    ...
    //lifecycle_version
    const val lifecycleLivedataktx = "androidx.lifecycle:lifecycle-livedata-ktx:${DepsVersion.lifecycleVersion}"
    const val lifecycleViewmodelKtx = "androidx.lifecycle:lifecycle-viewmodel-ktx:${DepsVersion.lifecycleVersion}"
    const val lifecycleProcess = "androidx.lifecycle:lifecycle-process:${DepsVersion.lifecycleVersion}"
    const val lifecycleRuntimeKtx = "androidx.lifecycle:lifecycle-runtime-ktx:${DepsVersion.lifecycleVersion}"

    const val databinding = "androidx.databinding:databinding-runtime:${DepsVersion.dataBindingVersion}"
    ...
    const val retrofitConverterGson = "com.squareup.retrofit2:converter-gson:${DepsVersion.retrofitSdkVersion}"
